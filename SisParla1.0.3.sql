...
CREATE TABLE IF NOT EXISTS PessoaJuridicaFisica(
IdPessoaJuridicaFisica INT NOT NULL AUTO_INCREMENT,
Nome VARCHAR(150) NOT NULL,
Endereco INT,
TELEFONE VARCHAR(20),
CNPJ VARCHAR(14),
CPF VARCHAR(11),
PRIMARY KEY(IdPessoaJuridicaFisica),
CONSTRAINT CK_PessoasJuridicasFisicas_CNPJ_CPF CHECK (CNPJ IS NOT NULL OR CPF IS NOT NULL),
FOREIGN KEY (Endereco) REFERENCES ENDERECO (idEndereco)
);
...
FOREIGN KEY (PessoaJuridicaFisica) REFERENCES PessoaJuridicaFisica (IdPessoaJuridicaFisica)
);
